...
import { BALLOON_OFFERS, BALLOON_DETAIL, SOCIAL_LINKS } from '../data';
...
export const BalloonSection: React.FC<BalloonSectionProps> = ({ onBookOffer }) => {
  return (
    <section id="balloon-section" className="w-full bg-[#FFFFFF] py-20 sm:py-28 text-[#111111] overflow-hidden border-b border-neutral-200">
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
          ...
          {BALLOON_OFFERS.map((offer) => (
            ...
            >
              ...
              <div className="flex justify-between items-center mb-4 text-[10px] uppercase tracking-[0.25em] text-neutral-400 font-semibold">
                <span>VIP Combo</span>
                <span>Hot Air Balloon &amp; Quad</span>
              </div>
              ...
              <div className="flex-1 flex flex-col justify-between">
                <h3 className="text-[#111111] text-lg sm:text-xl lg:text-2xl font-serif italic text-left uppercase tracking-wide leading-snug mb-6">
                  {offer.title}
                </h3>
        ...
        {/* Feature Visual with "Air ballon" typography */}
        <div className="bg-[#F7F7F7] border border-neutral-200 p-6 sm:p-10 lg:p-12">
          <div className="relative overflow-hidden h-80 sm:h-[450px] lg:h-[500px] bg-neutral-900 border border-neutral-200">
            <img
              src={BALLOON_DETAIL.featureImage}
              alt="Air Ballon Marrakech"
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end justify-between p-8 sm:p-14">
              <h3 className="text-4xl sm:text-7xl lg:text-9xl font-serif italic text-white capitalize tracking-tighter">
                {BALLOON_DETAIL.badgeOverlayText}
              </h3>
              <a
